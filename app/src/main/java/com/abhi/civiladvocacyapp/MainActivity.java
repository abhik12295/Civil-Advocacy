...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void loadData(String locationString) {
        if(locationString!=null && !locationString.isEmpty()) {
            ...
            if(hasNetworkConnection()) {
                CivicInformationAPI civicInformationDownloader = new CivicInformationAPI(MainActivity.this,locationString);
                new Thread(civicInformationDownloader).start();
            }
            else{
                errorDialog(getString(R.string.noInternet),getString(R.string.noInternetDialogMsg));
            }
        }
        else{
            errorDialog(getString(R.string.noLocation),getString(R.string.noLocationPermission));
        }
    }
    ...
    private String getPlace(Location loc) {
        ...
        try {
            ...
            if(addresses.size()==0){
                errorDialog(getString(R.string.noLocation), getString(R.string.invalidLocation));
                return null;
            }
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (et.getText().toString().isEmpty()) {
                            Toast.makeText(MainActivity.this, R.string.invalidLocation, Toast.LENGTH_SHORT).show();
                        } else {
                            if(hasNetworkConnection()) {
        ...
        try {
            ...
            if(hasNetworkConnection()) {
                if (officials != null) {
                    ...
                    Toast.makeText(MainActivity.this, R.string.noDataOfficials, Toast.LENGTH_SHORT).show();
                }
            }
            else{
                Toast.makeText(MainActivity.this, R.string.noInternet, Toast.LENGTH_SHORT).show();
